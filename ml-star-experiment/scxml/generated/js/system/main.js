// main.js — entry point for the HamiltonStarSystemSM state machine.
//
// Usage:
...
import { HamiltonStarSystemSM } from './hamilton-star-system-s-m.js';
...
const machine = new HamiltonStarSystemSM();
if (verbose) {
...
if (events.length > 0) {
    ...
    // ── Interactive mode ─────────────────────────────────────────────
    console.log('=== HamiltonStarSystemSM State Machine Demo ===');
    console.log();
    console.log('Active states:', [...machine.getActiveStateIds()].join(', ') || '(none)');
    console.log();
...
// );
// const tracedMachine = new HamiltonStarSystemSM();
